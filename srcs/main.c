...
/*   Updated: 2025/03/01 18:24:20 by pbret            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	while (1)
	// peut etre changer la condition pour une variable stocke dans la struct mshell et qui change d'etat pour sortir de minishell. (crtl+D ou exit)
	{
